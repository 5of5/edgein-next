...
export const generateVerifyWorkplaceToken = async (resourceId: string, resourceType: string, personId: number) => {
  return await new SignJWT({ resourceDetails: { resourceId, resourceType, personId } })
