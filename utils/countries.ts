export const countries = [
  ...
  { code: 'MAC', name: 'Macau' },
  { code: 'MAF', name: 'Collectivity of Saint Martin' },
  ...
  { code: 'NIU', name: 'Niue' },
  { code: 'NLD', name: 'Kingdom of the Netherlands' },
  ...
  { code: 'SXM', name: 'Sint Maarten|Sint Maarten (Dutch part)' },
  { code: 'SYC', name: 'Seychelles' },
  { code: 'SYR', name: 'Syria|Syrian Arab Republic' },
  ...
  { code: 'TLS', name: 'East Timor|Timor-Leste' },
  { code: 'TON', name: 'Tonga' },
