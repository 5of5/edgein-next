						...
						<Tab.Panels>
							<Tab.Panel>
								...
								<p>
									...
									gather when you access or use our Service. “Personal Data”
									means any information that identifies or relates to a
									...
									regulations. This Privacy Policy does not cover the practices
									of companies we don’t own or control or people we don’t
									manage.
								</p>
								...
								<p>
									...
									Service or business. We will post the changes to this page and
									encourage you to review our Privacy Policy to stay informed.
									If we make changes that materially alter your privacy rights,
									we will do our best to alert you to changes by placing a
									notice on the EdgeIn.io website, by sending you an email,
									and/or by some other means. Please note that if you’ve opted
									not to receive legal notice emails from us (or you haven’t
									provided us with your email address), those legal notices will
									still govern your use of the Service, and you are still
									responsible for reading and understanding them.
								</p>
								<p>
									If you use the Service after any changes to the Privacy Policy
									have been posted, that means you agree to all of the changes.
								...
								<ul>
									<li>
										...
										<ul>
											...
											<li>
												when Personal Data about you is automatically collected
												in connection with your use of our Service.
											</li>
										</ul>
									</li>
									<li>
										Third parties, both when they provide us with Personal Data
										about you and when we seek out information for Profiles, as
										discussed below (“Third Parties”). Third Parties that share
										your Personal Data with us include:
										<ul>
											<li>
												Service providers. For example, we may use analytics
												service providers to analyze how you interact and engage
												with the Service, or third parties may help us provide
												you with customer support.
											</li>
											<li>
												Other networks connected to the Service. If you provide
												any third-party account credentials to us or otherwise
												sign in to the Service through a third-party site or
												service (for example, using LinkedIn, Salesforce,
												Twitter, Facebook, or Google), you understand some
												content and/or information in those accounts may be
								...
								<p>
									EdgeIn.io also creates profiles of people and companies, which
									we call “Profiles,” from different sources. Once we have
									collected information (primarily business-related information)
									about a person or company, we combine multiple mentions of the
									same person or company into a Profile. Profiles are then made
									available to users of the Service, and our customers and
									strategic partners.
								</p>
								<p>
								...
								<ul>
									<li>
										Publicly-available web sources that we scan using technology
										or manual methods.
									</li>
									<li>
								...
								<p>
									...
									months. Throughout this Privacy Policy, we will refer back to
									the categories of Personal Data listed in this chart (for
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												Name, address, credit card type, last 4 digits of credit
												card
											</td>
											<td>You</td>
										</tr>
										...
										<tr>
											...
											<td>
												...
												being associated with or could reasonably be linked to a
								...
								<p>
									...
									phone number, and third-party account credentials (for
									example, your log-in credentials for LinkedIn, Salesforce,
									Twitter, Facebook, or Google). If you provide your third-party
									account credentials to us or otherwise sign into the Service
									through a third party site or service (such as LinkedIn,
									Salesforce, Twitter, Facebook, or Google), you understand some
									content and/or information in those accounts (“Third Party
									Account Information”) may be transmitted into your account
									with us, and that Third Party Account Information transmitted
									to our Service is covered by this Privacy Policy. Certain
									information may be required to register with us or to take
									advantage of some of our features.
								</p>
								<p>
									We may communicate with you if you’ve provided us the means to
									do so. For example, if you’ve given us your email address, we
									may send you promotional email offers on behalf of other
									businesses, or email you about your use of the Service. Also,
									we may receive a confirmation when you open an email from us,
									which helps us improve our Service. If you do not want to
									receive communications from us, please indicate your
									preference on the Account Information page or contact us
									at policy@EdgeIn.io.
								</p>
								<p>
									<em>Information Collected Automatically:</em> Like many other
									commercial websites, we may also gather information in
									connection with your use of the website or Service through the
									use of cookies and other similar technologies such as server
									logs, pixel tags, web beacons, user website activity and
									JavaScript (collectively, “Cookies”) to enable us to recognize
									your web browser or device and tell us how and when you visit
									and use our Service, to analyze trends, to learn about our
									user base, and to operate and improve our Service. Cookies are
									small pieces of data—usually text files—placed on your
									computer, tablet, phone, or similar device when you use that
									device to visit our Service. We may also supplement the
									information we collect from you with information received from
									third parties, including third parties that have placed their
									own Cookies on your device(s). Please note that because of our
									use of Cookies, the Service does not support “Do Not Track”
								...
								<ul>
									...
									<li>
										...
										to our Service. These Cookies help us to personalize our
									...
									<li>
										...
										Cookies allow us to understand how visitors use our Service
										such as by collecting information about the number of
										visitors to the Service, what pages visitors view on our
										Service and how long visitors are viewing pages on the
										Service. Performance/Analytical Cookies also help us measure
										the performance of our advertising campaigns in order to
										help us improve our campaigns and the Service’s content for
										those who engage with our advertising. For example, Google,
										Inc. (“Google”) uses cookies in connection with its Google
										Analytics services. Google’s ability to use and share
										information collected by Google Analytics about your visits
										to the Service is subject to the Google Analytics Terms of
										Service and the Google Privacy Policy. You have the option
										to opt-out of Google’s use of cookies by visiting the Google
									...
									<li>
										...
										Cookies collect data about your online activity and identify
										your interests so that we can provide advertising that we
										believe is relevant to you. For more information about this,
										please see the section below titled “Information about
								...
								<p>
									...
									turning off the Cookie feature, which will prevent your
									browser from accepting new Cookies, as well as (depending on
									the sophistication of your browser software) allow you to
									decide on acceptance of each new Cookie in a variety of ways.
									You can also delete all Cookies that are already on your
									computer. If you do this, however, you may have to manually
									adjust some preferences every time you visit a site, and this
									may cause some services and functionalities to not work.
								</p>
								...
								<p>
									...
									technology vendors and research firms, to serve advertisements
									through the Service. These advertisements may be targeted to
									users who fit certain general profile categories or display
									certain preferences or behaviors (“Interest-Based Ads”).
									Information for Internet-Based Ads (including Personal Data)
									may be provided to us by you, or derived from the usage
									patterns of particular users on the Service and/or services of
									third-parties. Such information may be gathered through
									tracking users’ activities across time and unaffiliated
									properties, including when you leave the Service. To
									accomplish this, we or our service providers may deliver
									Cookies, including a file (known as a “web beacon”) from an ad
									network to you through the Service. Web beacons allow ad
									networks to provide anonymized, aggregated auditing, research
									and reporting for us and for advertisers. Web beacons also
									enable ad networks to serve targeted advertisements to you
									when you visit other websites. Web beacons allow ad networks
									to view, edit or set their own Cookies on your browser, just
									as if you had requested a web page from their site.
								</p>
								<p>
									...
									Interest-Based Ads from participating third parties, including
									to opt-out of receiving behaviorally targeted advertisements
									from participating organizations, please visit the Digital
									Advertising Alliance or Network Advertising Initiative
								...
								<ul>
									...
									<li>
										...
										communications based on your preferences, including targeted
										offers and ads served through the Service.{" "}
									</li>
								...
								<p>
									...
									given us your email address, we may send you promotional email
									offers on behalf of other businesses or email you about your
									use of the Service.  Also, we may receive a confirmation when
									you open an email from us, which helps us improve our Service.
								...
								<ul>
									<li>
										...
										servicing accounts, providing customer service, processing
										or fulfilling orders and transactions, verifying customer
										information, processing payments, providing advertising or
										marketing services, providing analytic services, or
									...
									<li>
										...
										quality of ad impressions, and auditing compliance with this
									...
									<li>
										Short-term, transient use of Personal Data that is not used
										by another party to build a consumer profile or otherwise
										alter your consumer experience outside the current
										interaction.{" "}
									</li>
									<li>
									...
									<li>
										...
										safety of a service or device that we own, manufacture, was
										manufactured for us, or we control.{" "}
									</li>
								</ul>
								<p>
								...
								<ul>
									...
									<li>
										...
										<ul>
											<li>
												...
												undergo a merger, acquisition, bankruptcy or other
												transaction in which that third party assumes control of
									...
									<li>
										...
										categories of your Personal Data to service providers or
										other parties for the business purposes listed above:
										<ul>
								...
								<p>
									...
									(including information contributed directly by you and/or our
									user community) in order to compile Profiles about entities
									and individuals. Please refer to the chart above titled
									“Categories of Personal Data We Collect” for a better
									understanding of the Personal Data we collect that constitutes
									Profile data. {" "}
								</p>
								<p>
									In this section, we use the term ‘sell’ as it is defined in
									the CCPA. We sell your Profile data to our customers and data
									partners (such as resellers and syndication partners), subject
									to your right to opt-out of these sales (see the “Your Rights”
								...
								<p>
									...
									“sale” and, because of this, we are required to disclose these
									types of transfers as “sales” of personal information.
									However, we do not sell this information for monetary
									consideration. This type of sharing is also subject to your
									right to opt out of these sales (see the “Your Rights” section
									below for information about how to opt-out).
								</p>
								<p>
								...
								<p>
									...
									based on the type of Personal Data and how we are processing
									that data, including but not limited to:
								</p>
								<ul>
									...
									<li>
										The authenticity of request methods are verified to prevent
									...
									<li>
										Access to AWS and Payment Processors is limited on a need to
										know basis and requires Two-Factor Authentication (2FA).{" "}
									</li>
									<li>
								...
								<p>
									...
									your account. Although we work to protect the privacy of your
									account and other Personal Data that we hold in our records,
									no security system is impenetrable, and unanticipated system
									failures or the efforts of malicious actors are an unfortunate
									reality on the Internet. Therefore, EdgeIn.io cannot guarantee
									that Personal Data during transmission through the Internet or
								...
								<p>
									...
									open account with us or as otherwise necessary to provide the
									...
									aggregated form but not in a way that would identify you
									personally.{" "}
								</p>
								<p>
								...
								<p>
									As noted in the Terms of Service, we do not knowingly collect
									or solicit Personal Data from children under 16. If you are a
									child under 16, please do not attempt to register for or
									otherwise use the Service or send us any Personal Data. If we
									learn we have collected Personal Data from a child under 16,
								...
								<p>
									...
									in this section. Please see the &ldquo;Exercising Your
									Rights&rdquo; section below for instructions regarding how to
									exercise these rights. If there are any conflicts between this
									section and any other provision of this Privacy Policy and you
									are a California resident, the portion that is more protective
									of Personal Data shall control to the extent of such conflict.
									If you have any questions about this section or whether any of
								...
								<p>
									...
									that we have collected from you. Under the CCPA, this right is
									subject to certain exceptions: for example, we may need to
									retain your Personal Data to provide you with the Service or
									complete a transaction or other action you have requested. If
									your deletion request is subject to one of these exceptions,
								...
								<p>
									...
									to verify that you are the person about whom we have collected
									Personal Data, and (2) describes your request in sufficient
									detail to allow us to understand, evaluate, and respond to it.
									Each request that meets both of these criteria will be
									considered a &ldquo;Valid Request.&rdquo; We may not respond
									to requests that do not meet these criteria. We will only use
									Personal Data provided in a Valid Request to verify you and
									complete your request. You do not need an account to submit a
									Valid Request.{" "}
								</p>
								<p>
									We will work to respond to your Valid Request within 45 days
									of receipt. We will not charge you a fee for making a Valid
									Request unless your Valid Request(s) is excessive, repetitive,
									or manifestly unfounded. If we determine that your Valid
									Request warrants a fee, we will notify you of the fee and
								...
								<p>
									...
									you to reauthorize the sale of your Personal Data for at least
									12 months. However, you may change your mind and opt back in
									to Personal Data sales at any time by creating a new public
								...
								<p>
									...
									services, charge you different prices or rates, or provide you
									a lower quality of goods and services if you exercise your
									rights under the CCPA. However, we may have different tiers of
									services as allowed by applicable data protection laws
									(including the CCPA) with varying prices, rates, or levels of
									quality of the goods or services you receive related to the
								...
								<p>
									...
									of the sale of certain Personal Data to third parties who
									intend to license or sell that Personal Data. You can exercise
									this right by contacting us at 
									<a href="mailto:privacy@EdgeIn.io">privacy@EdgeIn.io</a> with
									the subject line &ldquo;Nevada Do Not Sell Request&rdquo; and
								...
								<p>
									...
									not hesitate to contact your EdgeIn.io representative or email
									us at  privacy@edgein.io.
								</p>
							</Tab.Panel>
							...
							<Tab.Panel>
								<p>
									...
									to EdgeIn.io&rsquo;s Privacy Shield Certification contained in
								...
								<p>
									...
									Data&rdquo; and &ldquo;processing&rdquo; as they are defined
									in the European Privacy Laws, but &ldquo;Personal Data&rdquo;
									generally means information that can be used to individually
									identify a person, and &ldquo;processing&rdquo; generally
									covers actions that can be performed in connection with data
									such as collection, use, storage and disclosure.  EdgeIn.io
									will be the controller of your Personal Data processed in
									connection with the Service. For purposes of this GDPR Privacy
									Notice, &ldquo;Personal Data&rdquo; includes (but is not
									limited to) Profile data, as defined in our Privacy Policy.
								</p>
								<p>
									...
									extent of such conflict.  If you have any questions about this
									notice or whether any of the following applies to you, please
									contact us at privacy@EdgeIn.io.  
								</p>
								<table>
									<thead>
										<tr>
									...
									<tbody>
										<tr>
											...
											<td>
												...
												use, pages/links clicked, traffic demographics, patterns
												of navigation, on potential security/spam breach, on
										...
										<tr>
											...
											<td>
												<p>
													...
													browsing sessions. Enable users to log back in when a
													new session is started. Prevent cross-site request
								...
								<p>
									...
									providers and agents who work on our behalf and provide us or
									you with services related to the purposes described in this
									Privacy Policy or our Terms of Service. These parties include:
								</p>
								<ul>
								...
								<p>
									...
									transaction initiated or authorized by you or provide you with
									a product or service you have requested.  In addition to those
									set forth above, these parties also include:
								</p>
								<ul>
									<li>
										Other users (where you post information publicly, direct us
										to share the information (such as with other members of your
										team), or as otherwise necessary to effect a transaction
										initiated or authorized by you through the Service) 
									</li>
									<li>
								...
								<ul>
									...
									<li>
										...
										enforce our terms of service, prevent spam or other unwanted
								...
								<p>
									...
									members of our corporate family. Furthermore, if we choose to
									buy or sell assets, user information is typically one of the
									transferred business assets. Moreover, if we, or substantially
									all of our assets, were acquired, or if we go out of business
									or enter bankruptcy, user information would be one of the
									assets that is transferred or acquired by a third party, and
									we would share Personal Data with the party that is acquiring
									our assets. You acknowledge that such transfers may occur, and
								...
								<p>
									...
									and organizational measures based on the type of Personal Data
								...
								<p>
									...
									Data about you for as long as you have an open account with us
									or as otherwise necessary to provide you with the Service. In
									some cases we retain Personal Data for longer if doing so is
									necessary to comply with our legal obligations, resolve
									disputes or collect fees owed, or is otherwise permitted or
								...
								<p>
									...
									attempt to register for the Service or send any Personal Data
									about yourself to us. If we learn that we have collected
									Personal Data from a child under age 16, we will delete that
									information as quickly as possible. If you believe that a
									child under 16 may have provided us Personal Data, please
									contact us at privacy@EdgeIn.io. 
								</p>
								...
								<p>
									...
									privacy@EdgeIn.io. Please note that in some circumstances, we
									may not be able to fully comply with your request, such as if
									it is frivolous or extremely impractical, if it jeopardizes
									the rights of others, or if it is not required by law, but in
									those circumstances, we will still respond to notify you of
									such a decision. In some cases, we may also need you to
									provide us with additional information, which may include
									Personal Data, if necessary to verify your identity and the
								...
								<ul>
									<li>
										...
										Data by emailing privacy@EdgeIn.io. 
									</li>
									<li>
										Rectification: If you believe that any Personal Data we are
										holding about you is incorrect or incomplete, you can
									...
									<li>
										...
										necessary to enable you to utilize some or all of our
										Service. 
									</li>
									<li>
										Portability: You can ask for a copy of your Personal Data in
										a machine-readable format. You can also request that we
									...
									<li>
										...
										complaint about EdgeIn.io&rsquo;s practices with respect to
										your Personal Data with the supervisory authority of your
										country or EU Member State. 
									</li>
								</ul>
								<p>
									Transfers of Personal Data: The Service is hosted and operated
									in the United States (&ldquo;U.S.&rdquo;) through EdgeIn.io
									and its service providers, and if you do not reside in the
									U.S., laws in the U.S. may differ from the laws where you
									reside. By using the Service, you acknowledge that any
									Personal Data about you, regardless of whether provided by you
									or obtained from a third party, is being provided to EdgeIn.io
									in the U.S. and will be hosted on U.S. servers, and you
									authorize EdgeIn.io to transfer, store and process your
									information to and in the U.S., and possibly other
									countries. You hereby consent to the transfer of your data to
									the U.S.
								</p>
								<h2>
								...
								<p>
									...
									our data practices generally, please contact EdgeIn using the
									following information:   
								</p>
								<ul>
									<li>Email address for contact: privacy@edgein.io</li>
									<li>
										Physical address: 1319 Leavenworth, San Francisco, CA 94109
									</li>
								</ul>
							</Tab.Panel>
						</Tab.Panels>
