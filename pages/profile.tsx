		...
		<div className="max-w-6xl px-4 pt-4 mx-auto sm:px-6 lg:px-8 lg:pt-10 mt-10">
			<div className="grid grid-cols-4 gap-4">
				...
				<div className="col-span-3">
					<div className="max-w-6xl bg-white rounded-lg py-7 px-5">
						...
						<div className="flex mt-3 mb-2">
							...
							<div className="flex">
								...
								<div className="ml-8 mt-5">
									<ul>
										<li className=" list-disc text-slate-500 font-Metropolis text-sm font-thin">Square images work best (at least 300 x 300 pixels) </li>
										<li className=" list-disc text-slate-500 font-metropolis text-sm font-thin">Crop your image before you upload</li>
										<li className=" list-disc text-slate-500 font-metropolis text-sm font-thin">Image upoloads are limited to 2MB</li>
										<li className=" list-disc text-slate-500 font-metropolis text-sm font-thin">Accepted image types JPG SVG AND PNG</li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div className="flex  mt-3 mb-2 relative">
							...
							<button className="absolute right-0 text-md text-purple-600">Edit</button>
						...
						<div className="flex  mt-3 mb-2 relative">
							...
							<div>
								<div className="w-96">
									...
									<div className="flex mt-3 mb-2">
										<button className="font-bold border-none rounded-3xl text-white px-5 py-1 from-blue-800 via-primary-500 to-primary-400 bg-gradient-to-r ">
											Change
										</button>
										<button className="border-none font-bold text-slate-600 bg-transparent rounded-lg p-2">Cancel</button>
									</div>
								</div>
							</div>
						...
						<div className="flex  mt-3 mb-2 relative">
							...
							<button className="absolute right-0 text-md text-purple-600">Add Workplace</button>
						...
						<div className="flex  mt-3 mb-2 relative">
							...
							<div className="flex">
								<ElemPhoto wrapClass="w-auto h-2 border rounded-md" photo={company} imgAlt="company logo" />
								...
								<div className="ml-2">
									...
									<p className="font-thin text-slate-500">August 2017-Present,5yrs 1 mo <br /> San Francisco Cow Boy Area</p>
								</div>
							</div>
