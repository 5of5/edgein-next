          ...
          <div className="pb-4 space-y-12 sm:grid sm:grid-cols-3 sm:gap-x-6 sm:gap-y-12 sm:space-y-0 lg:grid-cols-4 lg:gap-x-8">
            {/* {isLoading ? (
              ...
              sortedTeam?.map(member => (
                <div
                  key={member?.id}
                  className="flex flex-col w-full max-w-md mx-auto overflow-hidden transition duration-300 ease-in-out bg-dark-100 border border-gray-200 rounded-lg md:h-full">
                  <ElemLink
