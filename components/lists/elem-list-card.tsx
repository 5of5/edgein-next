...
export const ElemListCard: FC<Props> = ({
  ...
  //  border-neutral-700
  return (
    <div className="flex flex-col justify-between w-full p-4 mx-auto border border-gray-700 hover:border-gray-300 transition-all rounded-lg">
      <div>
        <ElemLink
          href={resourceUrl}
          ...
          <div className="leading-snug inline-flex space-x-0.5 align-middle px-2 py-0.5 text-xs border border-gray-300 text-gray-600 rounded-full">
            {resource.public ? (
              <IconGlobeAmericas
                title="Public"
