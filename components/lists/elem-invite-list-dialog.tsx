...
// Props: isOpen, listId, listName, onClose, onInviteSuccess
export type Props = {
  isOpen: boolean;
  listId: number;
  listName: string;
...
const ElemInviteListDialog: React.FC<Props> = ({
  isOpen,
  listId,
  listName,
  onClose,
  ...
  const {
    ...
    async () => {
      const res = await fetch('/api/invite-list-member/', {
        method: 'POST',
        headers: {
...
export default ElemInviteListDialog;
