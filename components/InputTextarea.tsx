...
export const InputTextarea: React.FC<PropsWithChildren<Props>> = ({
	...
	return (
		<>
			...
			<textarea
				className="w-full mt-1 px-3 py-1.5 text-lg text-dark-500 relative bg-white rounded-md border border-gray-100 outline-none resize-none hover:ring-primary-100 focus:outline-none focus:border-primary-500 hover:ring focus:ring focus:ring-primary-100"
				name={name}
				value={value}
				onChange={onChange}
				required={required}
