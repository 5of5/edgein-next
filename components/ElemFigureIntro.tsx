export const ElemFigureIntro = () => {
	return (
      ...
      > */}
			<div className="absolute -left-16 top-1/2 -translate-y-3/4 w-2/3 rounded-xl bg-[#f6f9fc] border border-white/50 -skew-x-6 shadow-card-large p-1.5 transition delay-500 duration-300 ease-in">
