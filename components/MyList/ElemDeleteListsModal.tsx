...
export const ElemDeleteListsModal: FC<Props> = ({ isOpen, onCloseModal, onDelete, listName }) => {
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white px-6 pb-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <p className='text-sm text-slate-600'>Are you sure you want to delete selection from {listName}?</p>
                </div>
