...
export const TagInputText: React.FC<PropsWithChildren<Props>> = ({
	...
	return (
		<div className={className}>
			...
			<div>
				<div className="border rounded w-full flex items-center px-2">
					...
					tags.map((tag, index) => {
						return (
							<div className="bg-indigo-100 inline-flex items-center text-sm rounded mt-2 mr-1">
								...
								<button onClick={() => { onRmoveTag(index) }} className="w-6 h-8 inline-block align-middle text-gray-500 hover:text-gray-600 focus:outline-none">
