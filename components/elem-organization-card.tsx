...
export const ElemOrganizationCard: React.FC<Props> = ({
  ...
  return (
    <ElemLink
      href={href}
      className="bg-white rounded-lg cursor-pointer p-7 flex flex-col md:h-full mx-auto w-full max-w-md transition duration-300 ease-in-out transform group hover:scale-102 hover:shadow-lg focus:ring focus:ring-primary-300"
    >
