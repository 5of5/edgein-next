          ...
          <div className="relative">
            <Combobox onChange={handleSelect}>
              <div className="flex flex-wrap items-center px-2 py-1.5 rounded-3xl ring-1 ring-slate-300 focus-within:ring-2 focus-within:ring-primary-500 focus-within:outline-none">
                ...
                {!isLoadingPlace && (
                  <Combobox.Input
                    className="relative flex-1 px-3 py-1 text-sm bg-dark-100 border-none rounded-full outline-none text-dark-500 ring-0 placeholder:text-slate-400 focus:outline-none focus:ring-0"
              ...
              {inputValue && (
                <Combobox.Options className="absolute z-50 w-full mt-1 overflow-auto bg-dark-100 border divide-y divide-gray-100 rounded-md shadow-xl border-dark-500/10 max-h-60 focus:outline-none">
                  <ComboboxResults
