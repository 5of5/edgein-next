      ...
      <div className="flex flex-wrap items-center space-x-6">
        ...
        {itemsPerPageOptions.length > 0 && onChangePageSize && (
          <select
            ...
            className="inline-flex justify-center text-sm font-medium text-gray-700 bg-dark-100 border border-gray-300 rounded-full hover:bg-gray-50 active:border-primary-500 focus:ring-0 pl-2.5 pr-8 py-1.5">
