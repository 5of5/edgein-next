...
export const IconDocumentDownload: React.FC<IconProps> = ({
	...
	return (
		...
		>
			...
			<path d="M8 8V14V8ZM8 14L5 11L8 14ZM8 14L11 11L8 14ZM13 19H3C2.46957 19 1.96086 18.7893 1.58579 18.4142C1.21071 18.0391 1 17.5304 1 17V3C1 2.46957 1.21071 1.96086 1.58579 1.58579C1.96086 1.21071 2.46957 1 3 1H8.586C8.8512 1.00006 9.10551 1.10545 9.293 1.293L14.707 6.707C14.8946 6.89449 14.9999 7.1488 15 7.414V17C15 17.5304 14.7893 18.0391 14.4142 18.4142C14.0391 18.7893 13.5304 19 13 19Z" stroke="#64748B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
		</svg>
	);
};
...
export const IconFlag: React.FC<IconProps> = ({ className, title }) => {
	return (
		...
		>
			...
			<path d="M10 1.5V7M1 19V15V19ZM1 15V3C1 2.46957 1.21071 1.96086 1.58579 1.58579C1.96086 1.21071 2.46957 1 3 1H9.5L10.5 2H19L16 8L19 14H10.5L9.5 13H3C2.46957 13 1.96086 13.2107 1.58579 13.5858C1.21071 13.9609 1 14.4696 1 15V15Z" stroke="#64748B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
		</svg>
	);
};
...
export const IconEventLine: React.FC<IconProps> = ({ className, title }) => {
	return (
		...
		>
			...
			<path d="M0.5 0L0.5 460" stroke="#C6C8FF" stroke-dasharray="6 6" />
		</svg>
	);
};
