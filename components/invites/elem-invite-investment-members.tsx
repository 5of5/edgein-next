...
export const ElemInviteInvestmentMembers: FC<Props> = ({ vcFirmName }) => {
  ...
  return (
    <div className="p-5 bg-dark-100 border border-gray-200 rounded-lg">
            ...
            <Fragment key={company?.id}>
              {canSendInvestorInvitation(userById?.users, company?.id) ? (
                <div
                  ...
                  <ElemPhoto
                    photo={company?.logo}
                    wrapClass="flex items-center justify-center shrink-0 w-10 h-10 bg-dark-100 border border-gray-200 rounded-lg overflow-hidden"
