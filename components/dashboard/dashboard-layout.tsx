  ...
  return (
    <>
      <div className="relative mt-2">
        ...
        <div className="hidden fixed z-10 inset-0 top-0 left-0 right-auto w-64 mt-14 border-r border-gray-200 bg-gray-50 overflow-y-auto scrollbar-hide lg:block">
          <DashboardSidebar />
        </div>

        <div className="min-h-[calc(100vh_-_3rem)] lg:pl-64">{children}</div>
      </div>
