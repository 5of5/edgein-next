		...
		<div className={`${className}`}>
			<div className="relative overflow-hidden -mx-3">
				<div className="absolute top left flex justify-between w-full h-full">
					...
					>
						<div className="flex items-center justify-center bg-white border border-dark-500/10 rounded-full w-10 h-10 opacity-75 transition-all ease-in-out duration-300 group-hover:opacity-100 group-hover:border-primary-500 group-hover:text-primary-500 sm:ml-1">
