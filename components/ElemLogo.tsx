export const ElemLogo = (
	props: { mode: "logo" | "icon"; className?: string } = { mode: "logo" }
) => {
	const customView = props.mode === "logo" ? "0 0 143 31" : "0 0 43 28";
