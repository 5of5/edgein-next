  ...
  return (
    <>
        ...
        <a
          ...
          {user?.person?.picture ? (
            <ElemPhoto
              ...
              wrapClass="flex items-center justify-center shrink-0 w-7 h-7 bg-black rounded-full shadow border border-black/10"
      ...
      <ElemModal
        ...
        panelClass="w-full h-full bg-black mb-14 pb-4">
        ...
        <nav className="grid grid-cols-2 gap-4 px-4">
          {menuPanel.map((item, index) => (
            <ElemLink
              ...
              href={item?.href ? item.href : ''}
              onClick={onClose}
              className="block p-3 transition duration-150 ease-in-out bg-black border border-gray-300 rounded-lg outline-none hover:bg-neutral-900">
              {item?.icon && (
          ...
          {navigation.resources.map(item => (
            <ElemLink
              ...
              href={item?.href ? item.href : ''}
              onClick={onClose}
              className="col-span-2 p-3 text-sm transition duration-150 ease-in-out bg-black border border-gray-300 rounded-lg outline-none hover:bg-neutral-900">
              {item.name}
            </ElemLink>
          ))}
