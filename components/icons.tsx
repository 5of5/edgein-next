...
export const IconSidebarList: FC<IconProps> = ({ className, title }) => {
  return (
    <svg
      className={className}
      viewBox="0 0 16 16"
...
export const IconSidebarGroups: FC<IconProps> = ({ className, title }) => {
  return (
    <svg
      className={className}
      viewBox="0 0 16 16"
...
export const IconSidebarNotes: FC<IconProps> = ({ className, title }) => {
  return (
    <svg
      className={className}
      viewBox="0 0 16 16"
    ...
    >
      ...
      <path
        d="M11.2413 2.99138L12.366 1.86604C12.6005 1.63159 12.9184 1.49988 13.25 1.49988C13.5816 1.49988 13.8995 1.63159 14.134 1.86604C14.3685 2.10049 14.5002 2.41848 14.5002 2.75004C14.5002 3.08161 14.3685 3.39959 14.134 3.63404L7.05467 10.7134C6.70222 11.0656 6.26758 11.3245 5.79 11.4667L4 12L4.53333 10.21C4.67552 9.73246 4.93442 9.29783 5.28667 8.94538L11.2413 2.99138ZM11.2413 2.99138L13 4.75004M12 9.33338V12.5C12 12.8979 11.842 13.2794 11.5607 13.5607C11.2794 13.842 10.8978 14 10.5 14H3.5C3.10218 14 2.72064 13.842 2.43934 13.5607C2.15804 13.2794 2 12.8979 2 12.5V5.50004C2 5.10222 2.15804 4.72069 2.43934 4.43938C2.72064 4.15808 3.10218 4.00004 3.5 4.00004H6.66667"
        stroke="currentColor"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const IconUserGroup: FC<IconProps> = ({ className, title }) => {
  return (
    <svg
      className={className}
      viewBox="0 0 16 16"
    ...
    >
      ...
      <path
        d="M11.3728 10.3473C11.6847 10.1344 12.0505 10.014 12.4279 10.0003C12.8053 9.98654 13.1788 10.0799 13.5054 10.2696C13.8319 10.4593 14.0981 10.7376 14.273 11.0722C14.448 11.4069 14.5247 11.7843 14.4942 12.1607C13.6943 12.4402 12.8447 12.549 12.0002 12.48C11.9976 11.7244 11.78 10.9845 11.3728 10.348C11.0114 9.78119 10.5129 9.31469 9.92337 8.99167C9.33385 8.66865 8.67237 8.49954 8.00015 8.5C7.32804 8.49966 6.6667 8.66881 6.07731 8.99183C5.48791 9.31485 4.98949 9.78129 4.62815 10.348M11.9995 12.4793L12.0002 12.5C12.0002 12.65 11.9922 12.798 11.9755 12.944C10.7657 13.6381 9.39488 14.0022 8.00015 14C6.55349 14 5.19549 13.616 4.02482 12.944C4.00768 12.7897 3.99944 12.6346 4.00015 12.4793M4.00015 12.4793C3.15591 12.5508 2.30676 12.4425 1.50749 12.1613C1.47705 11.785 1.55375 11.4078 1.72871 11.0733C1.90366 10.7387 2.16973 10.4605 2.49615 10.2709C2.82258 10.0812 3.19602 9.98777 3.5733 10.0014C3.95058 10.0151 4.31629 10.1352 4.62815 10.348M4.00015 12.4793C4.00255 11.7238 4.22124 10.9846 4.62815 10.348M10.0002 4.5C10.0002 5.03043 9.78944 5.53914 9.41437 5.91421C9.03929 6.28929 8.53059 6.5 8.00015 6.5C7.46972 6.5 6.96101 6.28929 6.58594 5.91421C6.21087 5.53914 6.00015 5.03043 6.00015 4.5C6.00015 3.96957 6.21087 3.46086 6.58594 3.08579C6.96101 2.71071 7.46972 2.5 8.00015 2.5C8.53059 2.5 9.03929 2.71071 9.41437 3.08579C9.78944 3.46086 10.0002 3.96957 10.0002 4.5ZM14.0002 6.5C14.0002 6.69698 13.9614 6.89204 13.886 7.07403C13.8106 7.25601 13.7001 7.42137 13.5608 7.56066C13.4215 7.69995 13.2562 7.81044 13.0742 7.88582C12.8922 7.9612 12.6971 8 12.5002 8C12.3032 8 12.1081 7.9612 11.9261 7.88582C11.7441 7.81044 11.5788 7.69995 11.4395 7.56066C11.3002 7.42137 11.1897 7.25601 11.1143 7.07403C11.039 6.89204 11.0002 6.69698 11.0002 6.5C11.0002 6.10218 11.1582 5.72064 11.4395 5.43934C11.7208 5.15804 12.1023 5 12.5002 5C12.898 5 13.2795 5.15804 13.5608 5.43934C13.8421 5.72064 14.0002 6.10218 14.0002 6.5ZM5.00015 6.5C5.00015 6.69698 4.96135 6.89204 4.88597 7.07403C4.81059 7.25601 4.7001 7.42137 4.56081 7.56066C4.42153 7.69995 4.25617 7.81044 4.07418 7.88582C3.89219 7.9612 3.69714 8 3.50015 8C3.30317 8 3.10812 7.9612 2.92613 7.88582C2.74414 7.81044 2.57878 7.69995 2.43949 7.56066C2.3002 7.42137 2.18972 7.25601 2.11433 7.07403C2.03895 6.89204 2.00015 6.69698 2.00015 6.5C2.00015 6.10218 2.15819 5.72064 2.43949 5.43934C2.7208 5.15804 3.10233 5 3.50015 5C3.89798 5 4.27951 5.15804 4.56081 5.43934C4.84212 5.72064 5.00015 6.10218 5.00015 6.5Z"
        stroke="currentColor"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeLinejoin="round"
