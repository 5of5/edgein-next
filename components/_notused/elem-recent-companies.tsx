              ...
              return (
                <ElemCarouselCard
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="box-border z-0 flex flex-col w-full h-full p-5 transition-all bg-dark-100 border rounded-lg border-black/10 hover:scale-102 hover:shadow">
                    <div className="flex items-center">
                      <ElemPhoto
                        photo={company.logo}
                        wrapClass="flex items-center justify-center aspect-square w-16 h-16 p-2 bg-dark-100 rounded-lg shadow"
