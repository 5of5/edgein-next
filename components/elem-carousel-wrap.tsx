    ...
    <div className={`${className}`}>
      <div className="relative overflow-hidden">
        <div className="absolute top left flex justify-between w-full h-full">
          <button
            onClick={movePrev}
            className="cursor-pointer from-white w-10 h-full rounded-lg group z-10 p-0 m-0 disabled:opacity-0 active:bg-transparent focus:bg-transparent"
          ...
          <button
            onClick={moveNext}
            className="cursor-pointer from-white w-10 h-full rounded-lg group z-10 p-0 m-0 transition-all ease-in-out duration-300 disabled:opacity-0"
