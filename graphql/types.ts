...
export const GetCompaniesRecentDocument = `
  ...
  companies(where: $where, order_by: {date_added: desc}, limit: $limit, offset: $offset) {
    id
    name
    slug
    logo
...
>(
	...
	useQuery<GetCompaniesRecentQuery, TError, TData>(
		...
		fetcher<GetCompaniesRecentQuery, GetCompaniesQueryVariables>(
...
useGetCompaniesRecentQuery.getKey = (variables: GetCompaniesQueryVariables) => [
	"GetCompaniesRecent",
	variables,
];
