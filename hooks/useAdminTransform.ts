...
type Props = {
  withImageTransformData: (data: any, imageResponse: any, finalValue: any) => {
    [key: string]: unknown;
  };
  withoutImageTransformData: (data: any, finalValue: any) => {
    [key: string]: unknown;
  };
}

const useAdminTransform = ({ withImageTransformData, withoutImageTransformData }: Props) => {
